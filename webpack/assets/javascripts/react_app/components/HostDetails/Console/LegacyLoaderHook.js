 ...
 * @param  {object} options includes request's headers and params, and DOM maniplation helpers
...
export const useDangerouslyLegacy = (
  type,
  url,
  { chosenElement, headers, params, elementsToRemove } = {}
) => {
  ...
  // constants
  const { current: _headers } = useRef(headers);
