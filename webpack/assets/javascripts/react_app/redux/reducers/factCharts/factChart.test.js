...
import { initialState, modalOpenState, modalSuccessState, modalLoadingState, modalErrorState, chartDataValues } from '../../../components/factCharts/factChart.fixtures';
...
describe('factCharts reducers', () => {
  ...
  it('should handle FACT_CHART_DATA_SUCCESS action', () => {
    expect(reducer(modalLoadingState, {
  ...
  it('should not display modal', () => {
    expect(reducer(modalSuccessState, {
