...
file under the folder /usr/share/foreman/bundler.d) and adding the following line
...
----
Install the 'preface' bundle by running from foreman core directory (/usr/share/foreman):

[source, bash]
----
BUNDLE_GEMFILE=Gemfile.in bundle install
----
