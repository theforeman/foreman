...
`extconf.rb:37:in `<main>': libvirt library not found in default locations (RuntimeError)`. The issue may be that the `pkgconfig` is in a different location than `/usr/lib64/pkgconfig`. Try to use this command: `export PKG_CONFIG_PATH=/usr/lib64/pkgconfig`.
