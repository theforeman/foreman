  ...
  class << self
    def seeded_templates
      [
        ...
        { :name => 'iPXE global default', :source => 'iPXE/ipxe_global_default.erb', :template_kind => kinds[:iPXE] },
        ...
        { :name => 'iPXE default local boot', :source => 'iPXE/ipxe_default_local_boot.erb', :template_kind => kinds[:iPXE] },
        ...
        { :name => 'RancherOS PXELinux', :source => 'PXELinux/rancheros_pxelinux.erb', :template_kind => kinds[:PXELinux] },
        { :name => 'RancherOS provision', :source => 'provision/rancheros_provision.erb', :template_kind => kinds[:provision] },
        ...
        { :name => 'csr_attributes', :source => 'snippet/_csr_attributes.yaml.erb', :snippet => true },
        ...
        { :name => 'rancheros_cloudconfig', :source => 'snippet/_rancheros_cloudconfig.erb', :snippet => true },
