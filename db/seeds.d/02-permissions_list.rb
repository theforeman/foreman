  ...
  class << self
    def permissions
      [
        ...
        ['AuthSources', 'view_auth_sources'],
        ['AuthSourceInternal', 'view_auth_sources_internal'],
        ['AuthSourceExternal', 'view_auth_sources_external'],
        ['AuthSourceExternal', 'create_auth_sources_external'],
        ['AuthSourceExternal', 'edit_auth_sources_external'],
