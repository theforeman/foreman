  ...
  class << self
    def permissions
      [
        ...
        ['SmartProxyPool', 'view_smart_proxy_pools'],
        ['SmartProxyPool', 'create_smart_proxy_pools'],
        ['SmartProxyPool', 'edit_smart_proxy_pools'],
        ['SmartProxyPool', 'destroy_smart_proxy_pools'],
        ['Image', 'view_images'],
        ['Image', 'create_images'],
        ['Image', 'edit_images'],
