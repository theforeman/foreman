class AddKeys < ActiveRecord::Migration[4.2]
  def change
    ...
    if ActiveRecord::Base.connection.adapter_name == 'PostgreSQL'
      ActiveRecord::Migration[4.2].execute "SET CONSTRAINTS ALL DEFERRED;"
    elsif ActiveRecord::Base.connection.adapter_name.downcase.starts_with? 'mysql'
      ActiveRecord::Migration[4.2].execute "SET FOREIGN_KEY_CHECKS=0;"
    end
    ...
    if ActiveRecord::Base.connection.adapter_name.downcase.starts_with? 'mysql'
      ActiveRecord::Migration[4.2].execute "SET FOREIGN_KEY_CHECKS=1;"
    end
  end
end
