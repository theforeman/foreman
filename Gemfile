...
# Pin rdoc to prevent psych bundle (https://github.com/ruby/rdoc/commit/ebe185c8775b2afe844eb3da6fa78adaa79e29a4)
# Pin psych is needed for Rails 6.0, Rails 6.1 should work with Psych > 4
gem 'rdoc', '~> 6.3.3'
gem 'rabl', '~> 0.14.2'
gem 'oauth', '>= 0.5.4', '< 1'
