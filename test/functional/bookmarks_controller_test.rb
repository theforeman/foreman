...
class BookmarksControllerTest < ActionController::TestCase
  ...
  test "should create bookmark" do
    ...
    assert_difference('Bookmark.count') do
      post :create, {:bookmark => {:name => "foo-bar", :query => "bar", :public => false, :controller => "systems"}}, set_session_user
    end
  ...
  test "should create bookmark with a dot" do
    User.current = users(:one)
    assert_difference('Bookmark.count') do
      post :create, {:bookmark => {:name => "facts.architecture", :query => " facts.architecture = x86_64", :public => false, :controller => "systems"}}, set_session_user
    end
