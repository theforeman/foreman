...
class Api::V2::ParametersControllerTest < ActionController::TestCase
  ...
  test "should not update with invalid separator in name" do
    ...
    assert_response :unprocessable_entity
    assert_equal param_name, Subnet.unscoped.find_by(name: subnet.name).parameters.
  ...
  test "should update nested host parameter" do
    ...
    assert_response :success
    assert_equal '123', Host.unscoped.find_by(name: @host.name).parameters.
  ...
  test "should update nested domain parameter" do
    ...
    assert_response :success
    assert_equal Domain.unscoped.find_by(name: "mydomain.net").parameters.
  ...
  test "should update nested subnet parameter" do
    ...
    assert_response :success
    assert_equal Subnet.unscoped.find_by(name: "five").parameters.
      order("parameters.updated_at").last.value, "123"
  end
  ...
  test "should update nested hostgroup parameter" do
    ...
    assert_response :success
    assert_equal Hostgroup.unscoped.find_by(name: "Common").group_parameters.
      order("parameters.updated_at").last.value, "123"
  end
  ...
  test "should update nested os parameter" do
    ...
    assert_response :success
    assert_equal Operatingsystem.unscoped.find_by(name: "Redhat").parameters.
      order("parameters.updated_at").last.value, "123"
  end
