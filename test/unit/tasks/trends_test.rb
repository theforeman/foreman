...
class TrendsTest < ActiveSupport::TestCase
  ...
  test 'trends:reduce does not iterfere between two trend ids' do
    trend1 = FactoryBot.create(:trend_os)
    trend2 = FactoryBot.create(:trend_os)
  ...
  test 'trends:reduce crossing graphs' do
    new_os_trend = FactoryBot.create(:trend_os)
    old_os_trend = FactoryBot.create(:trend_os)
  ...
  test 'trends:reduce can rerun with additional datapoint with the same value' do
    os_trend = FactoryBot.create(:trend_os)
    ...
    FactoryBot.create(:trend_counter, :trend => os_trend, :created_at => os_point_dates[3], :updated_at => os_point_dates[3], :count => 1)
