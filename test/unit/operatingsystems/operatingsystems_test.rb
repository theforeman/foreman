...
class OperatingsystemTest < ActiveSupport::TestCase
  {:coreos => { 'os' => :coreos, 'arch' => :x86_64, 'expected' => 'CoreOS 494.5.0'},
   ...
   :suse => { 'os' => :suse, 'arch' => :x86_64, 'expected' => 'OpenSuse 11.4'}}.each do |os, config|
  ...
  {:coreos =>
       { 'os' => :coreos, 'arch' => :x86_64, 'expected' => 'amd64-usr/$version'},
   :debian7_0 =>
       { 'os' => :debian7_0, 'arch' => :x86_64, 'expected' => 'dists/$release/main/installer-$arch/current/images/netboot/debian-installer/$arch'},
   :ubuntu14_10 =>
       { 'os' => :ubuntu14_10, 'arch' => :x86_64, 'expected' => 'dists/$release/main/installer-$arch/current/images/netboot/ubuntu-installer/$arch'},
   :suse =>
       { 'os' => :suse, 'arch' => :x86_64, 'expected' => 'boot/$arch/loader'}}.each do |os, config|
  ...
  {:coreos => { 'os' => :coreos, 'arch' => :x86_64, 'medium' => :coreos, 'expected' => 'boot/CoreOS-494.5.0-x86_64-coreos_production_pxe.vmlinuz'},
   ...
   :suse => { 'os' => :suse, 'arch' => :x86_64, 'medium' => :suse, 'expected' => 'boot/OpenSuse-11.4-x86_64-linux'}}.each do |os, config|
  ...
  {:coreos => { 'os' => :coreos, 'arch' => :x86_64, 'medium' => :coreos, 'expected' => 'boot/CoreOS-494.5.0-x86_64-coreos_production_pxe_image.cpio.gz'},
   ...
   :suse => { 'os' => :suse, 'arch' => :x86_64, 'medium' => :suse, 'expected' => 'boot/OpenSuse-11.4-x86_64-initrd'}}.each do |os, config|
  ...
  {:coreos => { 'os' => :coreos, 'arch' => :x86_64, 'medium' => :coreos, 'expected' => 'boot/CoreOS-494.5.0-x86_64'},
   ...
   :suse => { 'os' => :suse, 'arch' => :x86_64, 'medium' => :suse, 'expected' => 'boot/OpenSuse-11.4-x86_64'}}.each do |os, config|
  ...
  {:coreos => { 'os' => :coreos, 'arch' => :x86_64, 'medium' => :coreos,
   ...
   :suse => { 'os' => :suse, 'arch' => :x86_64, 'medium' => :suse,
              ...
              'initrd' => 'http://mirror.isoc.org.il/pub/opensuse/distribution/11.4/repo/oss/boot/x86_64/loader/initrd'}}.each do |os, config|
