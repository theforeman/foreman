...
Requires: %{?scl_prefix}rubygem-fog < 1.16.0
Requires: %{name} = %{version}-%{release}
...
%changelog
* Mon Dec 23 2013 Dominic Cleal <dcleal@redhat.com> - 1.3.2-1
- Release 1.3.2
- Pin fog to 1.15.x
...
- Release 1.3.0
* Tue Oct 08 2013 Lukas Zapletal <lzap+rpm[@]redhat.com> - 1.3.0-0.5.RC4
- Release 1.3.0-RC4
