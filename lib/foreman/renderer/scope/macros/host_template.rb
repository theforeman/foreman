      ...
      module Macros
        module HostTemplate
          ...
          apipie :method, 'Checks whether a parameter value is truthly or not' do
            ...
            optional :default_value, Object, desc: 'value to be used if the parameter is not set on host', default: false
          ...
          apipie :method, 'Checks whether a parameter value is falsy or not' do
            required :name, String, desc: 'name of the parameter'
            optional :default_value, Object, desc: 'value to be used if the parameter is not set on host', default: true
