module Api
  module V1
    class MediaController < BaseController
      ...
      @pathinfo = "The path to the medium, can be a URL or a valid NFS server
      ...
      @osfamilyinfo = "The family that the operating system belongs to.
                \nAvailable families: #{Operatingsystem.families.join('\n')}"
      ...
      param :medium, Hash, :required => true do
        ...
        param :path, String, :required => true, :desc => @pathinfo
        param :os_family, String, :require => false, :desc => @osfamilyinfo
      end
      def create
      ...
      param :medium, Hash, :required => true do
        ...
        param :path, String, :required => false, :desc => @pathinfo
        param :os_family, String, :require => false, :desc => @osfamilyinfo
      end
