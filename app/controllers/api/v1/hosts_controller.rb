  ...
  module V1
    class HostsController < V1::BaseController
      ...
      param :host, Hash, :required => true do
        ...
        param :managed, :bool, :desc => "True/Fase flag whether a host is managed or unmanaged. Note: this value also determines whether several parameters are required or not"
