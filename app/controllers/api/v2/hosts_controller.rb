    ...
    class HostsController < V2::BaseController
      ...
      def_param_group :host do
        param :host, Hash, :required => true, :action_aware => true do
          ...
          param :managed, :bool, :desc => N_("True/Fase flag whether a host is managed or unmanaged. Note: this value also determines whether several parameters are required or not")
