module Api
  module V2
    class PuppetclassesController < V2::BaseController
      ...
      def index
        values   = Puppetclass.reorder(nil).authorized(:view_puppetclasses).search_for(*search_options) unless nested_obj
      ...
      def update
        class_params = foreman_params.merge(:smart_class_parameter_ids => @puppetclass.smart_class_parameters.map(&:id))
