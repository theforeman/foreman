module Api::V2::LookupKeysCommonController
  extend ActiveSupport::Concern
    ...
    def find_smart_variables
      @smart_variables   = LookupKey.authorized(:view_external_variables).smart_variables.search_for(*search_options).paginate(paginate_options) unless (@puppetclass || @host || @hostgroup)
