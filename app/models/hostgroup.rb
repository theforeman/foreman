class Hostgroup < ApplicationRecord
  ...
  nested_attribute_for :compute_profile_id, :environment_id, :domain_id, :puppet_proxy_hostname_id, :puppet_ca_proxy_hostname_id,
  ...
  class Jail < Safemode::Jail
    allow :name, :diskLayout, :puppetmaster, :operatingsystem, :architecture,
      ...
      :subnet6, :realm, :root_pass, :description
  end
