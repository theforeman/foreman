    ...
    def guest_types_descriptions
      {
        ...
        "windows8Server64Guest" => "Windows Server 2012 (64 bit)",
        ...
        "winLonghornGuest" => "Windows Longhorn (32-bit)",
        ...
        "winNetDatacenterGuest" => "Windows Server 2003, Datacenter Edition (32-bit)",
        "winNetEnterprise64Guest" => "Windows Server 2003, Enterprise Edition (64-bit)",
        "winNetEnterpriseGuest" => "Windows Server 2003, Enterprise Edition (32-bit)",
        "winNetStandard64Guest" => "Windows Server 2003, Standard Edition (64-bit)",
        "winNetStandardGuest" => "Windows Server 2003, Standard Edition (32-bit)",
        ...
        "winXPProGuest" => "Windows XP Professional (32-bit)"
      }
    end
