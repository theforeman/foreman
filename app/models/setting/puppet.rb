  ...
  def self.load_defaults
    ...
    self.transaction do
      [
        ...
        self.set('puppet_server', N_("Default Puppet server system name"), "puppet"),
        self.set('failed_report_email_notification', N_("Enable Email alerts per each failed Puppet report"), false),
        self.set('Default_variables_Lookup_Path', N_("The Default path in which Foreman resolves system specific variables"), ["fqdn", "hostgroup", "os", "domain"]),
        ...
        self.set('use_uuid_for_certificates', N_("Should Foreman use random UUID's for certificate signing instead of system names"), false),
        ...
        self.set('host_group_matchers_inheritance', N_("Should Foreman use system group ancestors matchers to set puppet classes parameters values"), true),
        self.set('create_new_host_when_facts_are_uploaded', N_("Foreman will create the system when new facts are received"), true),
        self.set('create_new_host_when_report_is_uploaded', N_("Foreman will create the system when a report is received"), true),
        self.set('legacy_puppet_hostname', N_("Foreman will truncate systemname to 'puppet' if it starts with puppet"), false)
