  ...
  def self.load_defaults
    ...
    self.transaction do
      [
        ...
        self.set('unattended_url', N_(  "The URL for hosts which are building to get their templates from. (This is normally http as many installers don't support https)"), "http://#{Facter.fqdn}"),
