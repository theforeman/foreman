  ...
  def self.load_defaults
    ...
    self.transaction do
      [
        ...
        self.set('default_console_address', N_("The IP address that should be used for the console listen address when provisioning new virtual machines via Libvirt"), "0")
