...
class ApplicationRecord < ActiveRecord::Base
  ...
  apipie :prop_group, name: :basic_model_props do
    ...
    property :previous_revision, Object, desc: "Previous revision of the record as tracked in the audit, returns the same object if there is no previous revision"
  end
