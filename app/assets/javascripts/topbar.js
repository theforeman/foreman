...
$(document).on('mouseenter', '.list-group-item.secondary-nav-item-pf', function(){
  var me = $(this);
  if(!me.hasClass('open')) {
    me.addClass('open')
  }
...
$(document).on('mouseleave', '.list-group-item.secondary-nav-item-pf', function(){
  var me = $(this);
  me.removeClass('open')
})
...
function mark_active_menu() {
  ...
  $('.secondary-nav-item-pf').has(link).addClass('active');
}
