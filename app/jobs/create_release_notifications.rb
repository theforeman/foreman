class CreateReleaseNotifications < ApplicationJob
  def perform(options = {})
    UINotifications::ReleaseNotificationsChecker.new(options).deliver!
  ensure
  ...
  def humanized_name
    _('Create release notifications')
  end
end
