...
attributes :name, :id, :ip, :environment_id, :last_report, :updated_at, :created_at, :mac,
           ...
           :enabled, :puppet_ca_proxy_hostname_id, :managed, :use_image, :image_file, :uuid, :compute_resource_id,
           :puppet_proxy_hostname_id, :certname, :image_id, :created_at, :updated_at,
