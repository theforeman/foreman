...
Raphael.fn.g.piechart = function (cx, cy, r, values, opts) {
    ...
    if (len == 1) {
       /* series.push(this.circle(cx, cy, r).attr({fill: this.g.colors[0], stroke: opts.stroke || "#fff", "stroke-width": opts.strokewidth == null ? 1 : opts.strokewidth}));*/
        series.push(this.circle(cx, cy, r).attr({fill: opts.colors[values[0].order] || this.g.colors[values[0].order], stroke: opts.stroke || "#fff", "stroke-width": opts.strokewidth == null ? 1 : opts.strokewidth})); 
	    ...
	    var p = this.path(opts.init ? ipath : path).attr({fill: opts.colors && opts.colors[values[i].order] || this.g.colors[values[i].order] || "#666", stroke: opts.stroke || "#fff", "stroke-width": (opts.strokewidth == null ? 1 : opts.strokewidth), "stroke-linejoin": "round"}); 
            p.value = values[i];
